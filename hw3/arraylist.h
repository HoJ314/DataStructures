...
/* _________________
  ...
  \_________________/
    ...
    Error Handling: Whenever a function is given invalid parameter values
        ...
        is displayed. The list remains unchanged. If such function that
        encounters an error is supposed to return something, return the
        dummy member 'm_errobj'.
*/
...
// A GIFT FOR YOU!!
// This is the function to pretty print the list
